<h1 align="center">🚀AlphaOS - Arch-Based, Out-of-the-Box Linux🚀</h1>

<div align="center">

[**English**](ReadMe.md)  |  [**Español**](ReadMe_ES.md)
[**Overview**](#overview) |  [**Why AlphaOS?**](#why-catos)  |  [**Download**](#download) | [**Installation**](#installation) | [**Feedback**](#feedback)
</div>

## <font color=#2f81f7>Overview</font>

AlphaOS is an open-source, Arch-based, out-of-the-box Linux distribution designed to provide an excellent operating system user experience.
...
[**⬇️  Download AlphaOS ISO Image**](https://catos.info/en/docs/download)
...
*   Para assegurar a integridade e a segurança de sua imagem ISO baixada, recomenda-se **[Verificar o checksum da imagem ISO (SHA256 or others)]** após concluir o download. As informações de soma de verificação (Checksum) geralmente encontram-se na página de download. 
